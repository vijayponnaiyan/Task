  ...
  return (
    <>
      <div className='pt-24'>
        ...
        <div className="grid grid-cols-2 gap-6 p-10 sm:grid-cols-2 sm:gap-4 sm:p-5 sm:justify-center sm:place-items-center md:grid-cols-3 lg:grid-cols-6 lg:px-20">
          <div className="rounded-lg flex items-center justify-center w-32 h-32 sm:w-40 sm:h-40 transition-transform duration-300 hover:scale-110 hover:-translate-y-2">
            <img src={logoone} alt="Platform 1" className="h-16 w-auto sm:h-20" />
          </div>
          <div className="rounded-lg flex items-center justify-center w-32 h-32 sm:w-40 sm:h-40 transition-transform duration-300 hover:scale-110 hover:-translate-y-2">
            <img src={logotwo} alt="Platform 2" className="h-16 w-auto sm:h-20" />
          </div>
          <div className="rounded-lg flex items-center justify-center w-32 h-32 sm:w-40 sm:h-40 transition-transform duration-300 hover:scale-110 hover:-translate-y-2">
            <img src={logothree} alt="Platform 3" className="h-16 w-auto sm:h-20" />
          </div>
          <div className="rounded-lg flex items-center justify-center w-32 h-32 sm:w-40 sm:h-40 transition-transform duration-300 hover:scale-110 hover:-translate-y-2">
            <img src={logofour} alt="Platform 4" className="h-16 w-auto sm:h-20" />
          </div>
          <div className="rounded-lg flex items-center justify-center w-32 h-32 sm:w-40 sm:h-40 transition-transform duration-300 hover:scale-110 hover:-translate-y-2">
            <img src={logofive} alt="Platform 5" className="h-16 w-auto sm:h-20" />
          </div>
          <div className="rounded-lg flex items-center justify-center w-32 h-32 sm:w-40 sm:h-40 transition-transform duration-300 hover:scale-110 hover:-translate-y-2">
            <img src={logosix} alt="Platform 6" className="h-12 w-auto sm:h-16 " />
          </div>
        </div>
