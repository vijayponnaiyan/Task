...
export default function CustomerLogos() {
  return (
    <section className="dark:bg-gray-900 py-14 px-28 ">
      <Slider width="100%" duration={30} pauseOnHover={true}>
        <Slider.Slide>
          <img src={one} alt="Logo One" className="h-24" />
        </Slider.Slide>
        <Slider.Slide>
          <img src={two} alt="Logo Two" className="h-24" />
        </Slider.Slide>
        <Slider.Slide>
          <img src={three} alt="Logo Three" className="h-24" />
        </Slider.Slide>
