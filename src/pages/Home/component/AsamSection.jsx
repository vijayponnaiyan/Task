      ...
      <div className="pl-5 pr-5 z-10">
        <div className="flex flex-col-reverse md:flex-row bg-gray-100 p-10 rounded-lg shadow-lg">
            ...
            <div className="">
              <div className="space-y-4 text-gray-700   ">
                <p className="flex items-center text-lg">
                  <img src={icon} alt="icon" className="max-w-7 h-5 mr-2" />A
                  feature that empowers your iOS app to seamlessly secure itself
                  in the foreground.
                </p>
                <p className="flex items-center text-lg">
          ...
          <div className="flex-1 flex justify-center sm:justify-start  p-1">
            <img src={asam} alt="Single App Kiosk" className=" rounded-lg " />
          </div>
        </div>
      </div>
    </>
