    ...
    <div className=" aspect-retro pt-24 bg-slate-50  h-auto  p-10">
      ...
      <div className=" flex flex-wrap justify-center pt-20 ">
        ...
        <div className="w-full sm:w-56">
          <button
            type="button"
            className={`border-2 w-full  rounded-md p-6 flex items-center justify-between transition-colors duration-300 ${
              openIndex === 0
      ...
      <div className="h-auto sm:h-96 px-4 sm:px-8 lg:px-16 bg-slate-50">
        <div className="p-5  border-r-cyan-50 sm:p-8 lg:p-12"></div>
      </div>
    </div>
  );
};
